...
import {
  Home, Film, Heart, Clock, Settings, LogIn, LogOut,
} from 'lucide-react';
import { useAuthStore } from '@/store/useAuthStore';

// Search tab removed — search is now a Command Palette inside Home & Browse
const TABS = [
  ...
  return (
    <div className="cin-root">
      ...
      <style>{`
        ...
        /* ── Main — KEY FIX: margin-left matches sidebar width ── */
        .cin-main {
          flex: 1;
          min-width: 0;
          /* pushes content away from the fixed sidebar */
          margin-left: 64px;
          /* ensures no content bleeds under sidebar */
          position: relative;
          z-index: 1;
        }
